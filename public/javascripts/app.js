...
angular.module('app.routes', ['ui.router']).config(function ($stateProvider, $urlRouterProvider, $locationProvider) {
    $stateProvider.state('dashboard', {
        ...
        resolve: {
            ...
            username: function username(AuthService) {
...
angular.module('app.core').controller('DashboardController', function ($uibModal, $scope, $state, lists, username, ListService, AuthService) {
    var view = this;
